...
const mockHackathons: Hackathon[] = [
  ...
  },
  {
    ...
    description: "Revolutionize learning experiences with cutting-edge educational technology.",
    shortDescription: "Transform education through technology",
    bannerImageUrl: "https://images.unsplash.com/photo-1501504905252-473c47e087f8?w=800&auto=format&fit=crop&q=60",
  ...
  },
  {
    ...
    description: "Build robust security solutions to protect digital infrastructure.",
    shortDescription: "Defend the digital frontier",
    bannerImageUrl: "https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=800&auto=format&fit=crop&q=60",
  ...
  },
  {
    ...
    description: "Design IoT solutions to make cities smarter and more sustainable.",
    shortDescription: "Connected cities, better living",
    bannerImageUrl: "https://images.unsplash.com/photo-1573804633927-bfcbcd909acd?w=800&auto=format&fit=crop&q=60",
  ...
  },
  {
    ...
    description: "Create immersive gaming experiences using AR/VR/MR technologies.",
    shortDescription: "Build the metaverse",
    bannerImageUrl: "https://images.unsplash.com/photo-1552820728-8b83bb6b773f?w=800&auto=format&fit=crop&q=60",
  ...
  },
  {
    ...
    description: "Innovate agriculture with technology to improve farmer's productivity.",
    shortDescription: "Tech-enabled farming revolution",
    bannerImageUrl: "https://images.unsplash.com/photo-1625246333195-78d9c38ad449?w=800&auto=format&fit=crop&q=60",
    organizerName: "ICAR",
    organizerLogoUrl: null,
    organizerType: "government",
    category: "Open Innovation",
  ...
  },
  {
    ...
    description: "Build scalable cloud-native applications and services.",
    shortDescription: "Innovate on the cloud",
    bannerImageUrl: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=800&auto=format&fit=crop&q=60",
  ...
  },
  {
    ...
    bannerImageUrl: "https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?w=800&auto=format&fit=crop&q=60",
  ...
  },
  {
    ...
    description: "Extract meaningful insights from complex datasets using data science.",
    shortDescription: "Turn data into decisions",
    bannerImageUrl: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&auto=format&fit=crop&q=60",
  ...
  },
  {
    ...
    description: "Explore quantum algorithms and solve complex computational problems.",
    shortDescription: "Enter the quantum realm",
    bannerImageUrl: "https://images.unsplash.com/photo-1635070041078-e363dbe005cb?w=800&auto=format&fit=crop&q=60",
  ...
  },
  {
    ...
    description: "Develop technology solutions addressing critical social challenges.",
    shortDescription: "Tech for social good",
    bannerImageUrl: "https://images.unsplash.com/photo-1559027615-cd4628902d4a?w=800&auto=format&fit=crop&q=60",
